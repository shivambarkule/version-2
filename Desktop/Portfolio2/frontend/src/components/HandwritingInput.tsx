...
export default function HandwritingInput({
  ...
  // Complete letter bank with all SVG paths including missing letters and numbers
  const letterBank = {
    uppercase: {
    ...
    symbols: {
      ...
      '#': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 51" height="51" width="20"><path d="M6 10L6 35M14 10L14 35M2 18L18 18M2 27L18 27" stroke="#000" stroke-width="1.5"></path></svg>',
      '$': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 51" height="51" width="18"><path d="M9 5L9 46M14 12C14 9 12 7 9 7C6 7 4 9 4 12C4 15 6 17 9 17C12 17 14 19 14 22C14 25 12 27 9 27C6 27 4 25 4 22" stroke="#000" stroke-width="1"></path></svg>',
      '%': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 25 51" height="51" width="25"><path d="M6 12C6 9 7 8 9 8C11 8 12 9 12 12C12 15 11 16 9 16C7 16 6 15 6 12ZM18 28C18 25 19 24 21 24C23 24 24 25 24 28C24 31 23 32 21 32C19 32 18 31 18 28ZM3 8L22 40" stroke="#000" stroke-width="1"></path></svg>',
      '^': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 15 51" height="51" width="15"><path d="M3 20L7.5 10L12 20" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
      '&': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 22 51" height="51" width="22"><path d="M8 12C8 9 9 8 11 8C13 8 14 9 14 11C14 13 13 14 11 16L6 21C4 23 4 25 4 27C4 30 6 32 9 32C12 32 15 30 17 27L20 30" stroke="#000" stroke-width="1"></path></svg>',
      '*': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 15 51" height="51" width="15"><path d="M7.5 12L7.5 24M3 15L12 21M12 15L3 21" stroke="#000" stroke-width="1.5" stroke-linecap="round"></path></svg>',
      '(': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 51" height="51" width="10"><path d="M8 10C6 12 5 18 5 25.5C5 33 6 39 8 41" stroke="#000" stroke-width="1.5" stroke-linecap="round"></path></svg>',
      ')': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 51" height="51" width="10"><path d="M2 10C4 12 5 18 5 25.5C5 33 4 39 2 41" stroke="#000" stroke-width="1.5" stroke-linecap="round"></path></svg>',
      '-': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 15 51" height="51" width="15"><path d="M3 25.5L12 25.5" stroke="#000" stroke-width="1.5" stroke-linecap="round"></path></svg>',
      '_': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 15 51" height="51" width="15"><path d="M2 42L13 42" stroke="#000" stroke-width="1.5" stroke-linecap="round"></path></svg>',
      '+': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 15 51" height="51" width="15"><path d="M7.5 18L7.5 33M2 25.5L13 25.5" stroke="#000" stroke-width="1.5" stroke-linecap="round"></path></svg>',
      '=': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 15 51" height="51" width="15"><path d="M3 22L12 22M3 29L12 29" stroke="#000" stroke-width="1.5" stroke-linecap="round"></path></svg>',
      '/': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 15 51" height="51" width="15"><path d="M12 10L3 41" stroke="#000" stroke-width="1.5" stroke-linecap="round"></path></svg>',
      '\\': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 15 51" height="51" width="15"><path d="M3 10L12 41" stroke="#000" stroke-width="1.5" stroke-linecap="round"></path></svg>',
      ...
      '"': '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 12 51" height="51" width="12"><path d="M3 8L3 16M9 8L9 16" stroke="#000" stroke-width="1.5" stroke-linecap="round"></path></svg>',
      "'": '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 51" height="51" width="6"><path d="M3 8L3 16" stroke="#000" stroke-width="1.5" stroke-linecap="round"></path></svg>'
    }
  };
  ...
  const drawLetter = (key: string, animate: boolean = true) => {
    ...
    if (key === " ") {
      ...
      // Handle numbers with cursive SVGs
      const letter = document.createElement("div");
      letter.innerHTML = letterBank.numbers[key as keyof typeof letterBank.numbers] || `<span style="font-family: cursive; font-size: 18px;">${key}</span>`;
      ...
      // Debug: Check if letter exists in bank
      const hasUppercase = isUppercase && letterBank.uppercase[letterKey];
      const hasLowercase = letterBank.lowercase[letterKey];
      ...
      if (hasUppercase) {
        ...
        // Fallback - this will help us identify missing letters
        console.log(`Missing letter: ${key} (${letterKey}) - uppercase: ${hasUppercase}, lowercase: ${hasLowercase}`);
        // For now, let's use a simple cursive fallback that's properly aligned
        letter.innerHTML = `<span style="font-family: 'Dancing Script', cursive; font-size: 20px; vertical-align: baseline; line-height: 51px; height: 51px; display: inline-block;">${key}</span>`;
      }
      ...
      if (letterBank.symbols[key as keyof typeof letterBank.symbols]) {
        // Use cursive SVG for common symbols
        letter.innerHTML = letterBank.symbols[key as keyof typeof letterBank.symbols];
        letter.style.display = "inline-block";
        letter.style.verticalAlign = "baseline";
        ...
        letter.innerHTML = `<span style="font-family: cursive; font-size: 18px; vertical-align: baseline;">${key}</span>`;
        letter.style.display = "inline-block";
        letter.style.verticalAlign = "baseline";
      }
  ...
  const handleKeyDown = (event: React.KeyboardEvent<HTMLInputElement>) => {
    ...
    if ((event.code === `Key${key.toUpperCase()}`) || (event.code === 'Space')) {
      drawLetter(key, true);
  ...
  return (
    <div className={`relative ${className}`}>
      {/* Visible input field - transparent but interactive */}
      <input
        ref={inputRef}
        type={type}
        name={name}
        ...
        placeholder=""
        required={required}
        className="w-full px-4 py-3 border border-black/20 rounded-md focus:outline-none focus:ring-1 focus:ring-black/40 focus:border-black/40 transition-colors bg-white text-transparent caret-black"
        autoComplete="off"
      ...
      {!value && placeholder && (
        <div className="absolute inset-0 px-4 py-3 pointer-events-none flex items-center text-black/50">
          {placeholder}
        </div>
      )}
    </div>
