...
export default function MobileAppPage() {
  const [mobileProjects, setMobileProjects] = useState<ProjectData[]>([]);
  ...
  useEffect(() => {
    async function loadProjects() {
      try {
        ...
        // Get projects with category "Mobile App"
        const mobileApps = allProjects.filter(project => project.category === "Mobile App");
        setMobileProjects(mobileApps);
      } catch (error) {
    ...
    <div className="min-h-full">
      <div className="p-6 md:p-10 pb-20">
        ...
        <nav className="text-[11px] uppercase tracking-[0.12em] text-black/60 mb-8">
          ...
          <span className="mx-2">&gt;</span>
          <span className="text-black font-medium">MOBILE APP</span>
        </nav>

        {/* Header */}
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-light tracking-tight mb-6">Mobile Applications</h1>
