...
export default function WebsitePage() {
  const [websiteProjects, setWebsiteProjects] = useState<ProjectData[]>([]);
  ...
  useEffect(() => {
    async function loadProjects() {
      try {
        ...
        // Get projects with category "Website"
        const websites = allProjects.filter(project => project.category === "Website");
        setWebsiteProjects(websites);
      } catch (error) {
  ...
  return (
    <div className="min-h-full">
      <div className="p-6 md:p-10 pb-20">
        ...
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-light tracking-tight mb-6">Websites</h1>
          <p className="text-lg text-black/70 max-w-2xl">
            Static and dynamic websites built with modern web technologies and responsive design.
          </p>
        </div>
